...
import {selectTrue, ToPersistentData} from "Repositories/ViewModelTransformer";
import {CreateRequest} from 'Repositories/FooApiDriverInterface';
import FormViewModel from "../ViewModels/FormViewModel";

// export const toViewData: ToViewData<FormViewModel> = () => (new FormViewModel({}));

export const toCreateRequest: ToPersistentData<FormViewModel, CreateRequest> = (viewModel) => {
